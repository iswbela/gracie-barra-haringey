  ...
  return (
    <section className="py-20 bg-neutral-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="font-serif text-4xl lg:text-5xl font-bold text-neutral-900 mb-4">
            The GB Wear Promise
          </h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {perks.map(({ icon, title, desc }, i) => (
            <motion.div
              ...
              className="flex flex-col items-center text-center gap-4 p-6 rounded-2xl bg-white border border-neutral-200 hover:border-brand-500/40 transition-colors shadow-sm"
            >
        ...
        <motion.div
          ...
          whileInView={{ opacity: 1, y: 0 }}
          viewport={{ once: true }}
          className="mt-16 p-10 rounded-3xl bg-neutral-900 border border-neutral-700 text-center"
        >
